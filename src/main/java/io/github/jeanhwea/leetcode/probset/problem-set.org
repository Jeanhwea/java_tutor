...
* 链表 List
  ...
  4. [ ] [[https://leetcode-cn.com/problems/remove-duplicates-from-sorted-list/][LC083]] [[file:ch02/Solution083.java][删除排序链表中的重复元素]]
  5. [ ] [[https://leetcode-cn.com/problems/remove-duplicates-from-sorted-list-ii/][LC082]] [[file:ch02/Solution082.java][删除排序链表中的重复元素 II]]
  6. [ ] Rotate List
